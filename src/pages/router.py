...
from src.todo.router import item_id
...
def get_search_page(request: Request, todos=Depends(item_id)):
    return templates.TemplateResponse("item.html", {"request": request, "todos": todos["data"]})
