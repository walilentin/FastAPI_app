...
from src.operations.models import metadata as posts_metadata
from src.todo.models import metadata as todo_metadata
...
target_metadata = [users_metadata, posts_metadata, todo_metadata]
